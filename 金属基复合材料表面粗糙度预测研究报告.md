...
<div align="center">
  <img src="./maml_framework.png" alt="MAML框架原理图" width="800"/>
...
<div align="center">
  <img src="./maml_gradients.png" alt="MAML梯度计算示意图" width="700"/>
...
<div align="center">
  <img src="./maml_application.png" alt="MAML在加工领域应用场景" width="800"/>
...
<div align="center">
  <img src="./prediction_analysis.png" alt="预测性能综合分析图" width="800"/>
...
<div align="center">
  <img src="./correlation_matrix.png" alt="特征相关性矩阵图" width="600"/>
  <p><em>图5: 特征相关性矩阵图</em></p>
</div>

<div align="center">
  <img src="./feature_distributions.png" alt="特征分布图" width="800"/>
  <p><em>图6: 特征分布图</em></p>
</div>

<div align="center">
  <img src="./ra_distribution.png" alt="Ra值分布图" width="500"/>
  <p><em>图7: Ra值分布图</em></p>
</div>

<div align="center">
  <img src="./training_loss_curve.png" alt="训练损失曲线图" width="600"/>
...
- [`test.py`](./test.py): 模型测试与可视化脚本
- [`analyze_data.py`](./analyze_data.py): 数据分析脚本
- [`inner_loop.py`](./inner_loop.py): 内循环更新逻辑
- [`config.py`](./config.py): 配置参数文件
- [`generate_maml_diagrams.py`](./generate_maml_diagrams.py): MAML原理图生成脚本

### 7.2 模型文件
- [`maml_model.pth`](./maml_model.pth): 训练好的MAML模型权重

### 7.3 可视化成果
- [`maml_framework.png`](./maml_framework.png): MAML框架原理图
- [`maml_gradients.png`](./maml_gradients.png): MAML梯度计算示意图
- [`maml_application.png`](./maml_application.png): MAML应用场景图
- [`prediction_analysis.png`](./prediction_analysis.png): 预测性能综合分析图
- [`correlation_matrix.png`](./correlation_matrix.png): 特征相关性矩阵图
- [`feature_distributions.png`](./feature_distributions.png): 特征分布图
- [`ra_distribution.png`](./ra_distribution.png): Ra值分布图
- [`training_loss_curve.png`](./training_loss_curve.png): 训练损失曲线图
...
#### 内循环更新 ([`inner_loop.py`](./inner_loop.py))
```python
def inner_update(model, support_x, support_y, lr):
    """执行内循环快速适应"""
    weights = dict(model.named_parameters())
